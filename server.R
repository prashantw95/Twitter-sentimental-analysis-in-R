...
shinyServer(function(input, output, session) {
  consumer_api_key <- "IGYmZvT8Xz10ymoJsBPDz1ATV" # Enter your consumer key
  consumer_api_secret <- "pmRXJY0pulWLIU3x8AUFNpkfmFeopopV9XkITKJo2S9s9BikT3" # Enter your consumer secret
  access_token <- "1055189598-rSoE79ejm5zgxdKGXF7wvsOynKbh2TiDuibavKK" # Enter your access token
  access_token_secret <- "DY8vV88gvgRHJBxTujay2uh9272FYZTrMydm7eISAHo4o" # Enter your access secret
